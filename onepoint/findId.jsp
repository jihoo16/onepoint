	...
	<div id="wrapper">
		...
		<div class="right">
			<div class="formwrap">
				<h4>ONE POINT</h4>
				<h2>고객사 아이디 찾기</h2>
				<p>가입하신 핸드폰 번호를 입력해주세요</p>
				<form  action="findOut.jsp" class="needs-validation"
					novalidate onsubmit="return checkForm()" method="post">
					<div class="inputbox">
						<label for="validationTooltip01"> </label> <input type="text"
							class="form-control" id="validationTooltip01" value="" required
							placeholder="010XXXXXXXX" name="phone">
							
						<button class="btn btn-primary" type="submit">인증 번호 받기</button>
					</div>
					<%
    String error = request.getParameter("error");
   	if(error !=null){
   		out.println("<div class='alert alert-danger'>");
   		out.println("전화번호를 확인해주세요.");
   		out.println("</div>");
   	}
   %>
					<button class="btn btn-primary btn2" type="submit">아이디 찾기</button>
				</form>
