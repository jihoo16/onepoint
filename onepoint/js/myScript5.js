$(function(){
	...
	$(".thirdinwrapone").hide();
	$(".thirdinwraptwo").hide();
	$(".thirdinwrapthree").hide();
	function animateDots() {
        $(".dot").fadeOut(0);
        $(".five2").fadeIn(0).delay(3000).fadeOut(0);
       $(".thirdinwraptwo").fadeIn(0).delay(3000).fadeOut(0);

        $(".five1").delay(3000).fadeIn(0).delay(3000).fadeOut(0);
         animateValue(obj, 0, 98, 1000);
        animateValue(obj2, 0, 87, 1000);
        animateValue(obj3, 0, 75, 1000);
        $(".thirdinwrapone").delay(3000).fadeIn(0).delay(3000).fadeOut(0);
       
        $(".thirdinwrapthree").delay(6000).fadeIn(0).delay(3000).fadeOut(0);
        $(".five3").delay(6000).fadeIn(0).delay(3000).fadeOut(0).queue(function() {
          animateDots();
